...
def configuration_shadowsocks():
    ...
    #生成配置log
    with open(r'/etc/shadowsocks.json',mode='rb') as src_file,open(r'/root/shadowsocks.log',mode='wb') as dis_file:
...
def configuration_self_startup():
    ...
    '''
    #编辑启动脚本
    with open(r'/etc/systemd/system/shadowsocks.service',mode='w') as f:
        f.write('''
    [Unit]
